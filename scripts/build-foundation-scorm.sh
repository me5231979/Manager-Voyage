...
cp foundation/index.html foundation/pager.js foundation/app.js foundation/narration-scripts.js foundation/resources.js foundation/guide.html foundation/Manager-Foundations-Course-1.pdf "$STAGE/foundation/"
