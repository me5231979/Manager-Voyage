...
<div class="box"><b class="k">How we operate</b>To achieve the vision, Vanderbilt operates at uncommon speed, agility, and scale, addressing relevant societal challenges through education and research. Three areas of focus make that real.</div>
...
<div class="week" style="margin-top:8pt"><b>Your responsibility</b><p style="font-family:'Libre Caslon Display',Georgia,serif;font-size:13pt;line-height:1.2;margin:2pt 0 6pt">As a manager, it is your responsibility to embody this mission and to lead your team to achieve it.</p><ul><li><b>Embody it.</b> Speed, agility, and scale start with how you work. Your team watches what you do before it hears what you say.</li><li><b>Lead your team to achieve it.</b> Connect the team’s work to the mission, say the why, then decide, unblock, and finish.</li><li><b>Stay in touch with your manager.</b> Strategy, projects, priorities, and anything else, so your team hears it from you first.</li></ul></div></section>`);
// topic 1
