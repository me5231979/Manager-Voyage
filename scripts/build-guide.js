...
<header class="cover">
  ...
  <div class="meta"><span>About 35 minutes online</span><span>19 slides · 5 topics</span><span>Before: manager compliance courses</span><span>After: the twenty-two micro modules in Oracle Learning</span><span>Recorded in Oracle Learning</span></div>
</header>`);
// at a glance
...
// learning
H.push(`<section class="learn"><span class="eyebrow">Keep learning</span><h2>What to take <em>next</em>.</h2><p class="tx2">Your twenty-two micro modules in Oracle Learning, in the four tracks you take them in, then a short chosen list: ten more courses, podcasts, videos, and a guide. Micro modules first: Systems and Vanderbilt &amp; Nashville by Day 30, People and Processes by Day 60. Then one item a month, on the habit you are working on. Links are live in the PDF; in Oracle Learning you can also search by title.</p>`);
