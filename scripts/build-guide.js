...
.cover{ padding:.6in 0 .35in; border-bottom:3px solid var(--gold); display:flex; flex-direction:column; gap:14pt; }
...
section{ padding:16pt 0 6pt; break-inside:auto; } section + section{ border-top:1px solid var(--bd); }
...
<header class="cover">
  ...
  <div class="meta"><span>About 20 minutes online</span><span>18 pages · 5 topics</span><span>Before: manager compliance courses</span><span>After: the micro modules</span><span>Recorded in Oracle Learning</span></div>
</header>`);
// at a glance
H.push(`<section><span class="eyebrow">The course at a glance</span><h2>Five topics, one <em>picture</em>.</h2>
<div class="topic"><span class="n">01</span><div><b>What changed, and what a manager is</b><span class="tx2">The one change, three things that are new, what a manager is not, who helps you here.</span></div><span class="pg">Pages 3 to 4</span></div>
<div class="topic"><span class="n">02</span><div><b>Five ideas every good manager relies on</b><span class="tx2">Priorities, clear expectations, psychological safety, purpose, the people work. Each with a moment to try.</span></div><span class="pg">Page 5</span></div>
<div class="topic"><span class="n">03</span><div><b>What Vanderbilt will ask you to do</b><span class="tx2">The tasks of year one, when they show up, and your first calls: handle it, ask, route, or report.</span></div><span class="pg">Pages 6 to 7</span></div>
<div class="topic"><span class="n">04</span><div><b>The four jobs of a manager</b><span class="tx2">Get the work done, take care of your people, make things better, connect your team. One page each, then your call.</span></div><span class="pg">Pages 8 to 13</span></div>
<div class="topic"><span class="n">05</span><div><b>Your assessment results</b><span class="tx2">What the Manager Effectiveness Assessment asked, and your starting point.</span></div><span class="pg">Page 14</span></div>
...
// topic 1
H.push(`<section class="brk"><span class="eyebrow">Topic 1 · What changed</span><h2>Your job used to be your work. Now it is the team’s work, and the <em>people</em>.</h2>
<div class="grid3">
...
<div class="box gold"><b class="k">Who helps you</b><ul><li><b>Your unit leader:</b> direction and priorities.</li><li><b>Your Engagement Consultant:</b> your go-to in PCB for HR issues, concerns, and support; the bigger people questions for your business unit.</li><li><b>Your HCM:</b> in most business units, for immediate HR issues: pay, hiring, performance, policy. First call when unsure.</li><li><b>The leave office:</b> time off for health and family. Same day. Never ask for a diagnosis.</li><li><b>EOA:</b> discrimination and harassment reports. Same day. You report; you do not investigate.</li><li><b>My Voyage:</b> your dashboard, the micro modules, and who to call.</li></ul></div></div></section>`);
// topic 2
H.push(`<section class="brk"><span class="eyebrow">Topic 2 · Five ideas</span><h2>Five ideas every good manager <em>relies</em> on.</h2>`);
...
// topic 3
H.push(`<section class="brk"><span class="eyebrow">Topic 3 · Your first year</span><h2>What Vanderbilt will ask you to do, and <em>when</em>.</h2><p class="tx2">Each task names its micro module in brackets. All of them are on your dashboard.</p><div class="grid2">`);
...
// situations
H.push(`<section class="brk"><span class="eyebrow">Quick reference · Something just landed on your desk</span><h2>The first move, and what <em>never</em> to do.</h2>`);
...
H.push(`</section>`);
// topic 4
H.push(`<section class="brk"><span class="eyebrow">Topic 4 · The four jobs</span><h2>One picture that holds the whole <em>job</em>.</h2><p class="tx2">Nothing new to memorize: the same work, sorted. The Manager Effectiveness Assessment scores the same habits.</p><div class="grid2">`);
...
// topic 5
H.push(`<section class="brk"><span class="eyebrow">Topic 5 · Your results</span><h2>Reading your Manager Effectiveness Assessment <em>results</em>.</h2>
...
<div class="box"><b class="k">Today</b><strong>Open your dashboard</strong>Micro modules in your order, your compliance list, who to call.</div>
...
<div class="week" style="margin-top:8pt"><b>Tell your unit leader</b>“I just finished the first Manager Foundations course. The habit I am practicing this week is [habit]. Ask me about it on [date].”</div></section>`);
// learning
H.push(`<section class="brk learn"><span class="eyebrow">Keep learning</span><h2>What to take <em>next</em>.</h2><p class="tx2">Ten courses in Oracle Learning, in order, and ten things from outside. Micro modules first. Then one item a month, on the job your results pointed to. Links are live in the PDF; in Oracle Learning you can also search by title.</p>`);
...
H.push(`</section>
<footer class="foot"><b>Vanderbilt University · People, Culture and Belonging · Futures Learning Hub.</b> Manager Voyage, Manager Foundations, Course 1: You Are a Manager Now. This guide mirrors the online course at the time it was generated; the course and your dashboard are the current version. Questions about a situation: your HCM first, your Engagement Consultant for the bigger ones.</footer>
</div></body></html>`);
