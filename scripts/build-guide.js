...
// mission
H.push(`<section class="brk"><span class="eyebrow">The mission</span><h2>Define the great university of the 21st century, and <em>be</em> it.</h2>
<div class="grid3">
<div class="box"><b class="k">The vision</b>Vanderbilt will define the great university of the 21st century and be it, and help reclaim the essential role of leading research universities in driving American prosperity.</div>
<div class="box"><b class="k">How we operate</b>Uncommon speed, agility, and scale. Exceptional core operations are the fuel; bold initiatives and industry leadership are what they power.</div>
<div class="box"><b class="k">As we grow</b>Vanderbilt now works from more places: Nashville, San Francisco, West Palm Beach, New York City, and Chattanooga. As we grow, help your team understand how we operate, wherever they sit.</div></div>
<div class="week" style="margin-top:8pt"><b>As a manager, your focus</b><ul><li><b>Align.</b> Connect your team’s work to the mission. Say the why.</li><li><b>Progress.</b> Move it forward with speed, agility, and scale: decide, unblock, finish.</li><li><b>Stay in touch with your manager.</b> Strategy, projects, priorities, and anything else, so your team hears it from you first.</li></ul></div>
<p class="tx2" style="margin-top:8pt;font-style:italic">“Our mission is not small. We are scaling Mount Everest. Climbing Everest requires courage and commitment. But it promises the professional experience of a lifetime to all who sign on. And we will support one another at every step of the way.” Chancellor Diermeier</p></section>`);
// topic 1
...
// topic 3
H.push(`<section class="brk"><span class="eyebrow">Topic 3 · Your first year</span><h2>What Vanderbilt will ask you to do, and <em>when</em>.</h2><p class="tx2">Each task names its micro module in brackets. Each is a short how-to of its own.</p><div class="grid2">`);
